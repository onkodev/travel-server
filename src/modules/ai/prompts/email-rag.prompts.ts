...
export const INTEREST_KEYWORDS: Record<string, string> = {
  // 메인 카테고리
  culture:
    'palaces, temples, historical sites, traditional villages, museums, UNESCO heritage, royal tombs, fortress walls',
  kculture:
    'K-pop fan spots, K-drama filming locations, K-beauty shops, Gangnam entertainment, Hongdae indie scene, concert halls',
  food_shopping:
    'Korean BBQ restaurants, street food markets, traditional food alleys, Gwangjang Market, Myeongdong shopping, Korean cosmetics shops',
  nature:
    'national parks, hiking trails, Bukhansan, scenic viewpoints, botanical gardens, riverside walks, beaches',
  local:
    'local neighborhoods, hidden cafes, off-the-beaten-path alleys, temple stay experiences, traditional craft workshops',
  // 서브 카테고리
  historical:
    'Joseon dynasty palaces, fortress walls, royal tombs, war memorials',
  museums: 'National Museum of Korea, art galleries, war museums, folk museums',
  architecture:
    'Dongdaemun Design Plaza, traditional hanok, modern Seoul architecture',
  kpop: 'HYBE Insight, SM Entertainment, idol cafes, K-pop merchandise shops, Gangnam K-Star Road',
  kdrama:
    'drama filming locations, Nami Island, K-drama photo spots, famous drama sets',
  beauty:
    'K-beauty flagship stores, Myeongdong cosmetics street, skincare experiences',
  food: 'Korean BBQ, bibimbap, kimchi jjigae, tteokbokki, fine dining Korean cuisine',
  markets:
    'Namdaemun Market, Gwangjang Market, Noryangjin Fish Market, Dongdaemun wholesale',
  ...
  hidden_places:
    'Ikseon-dong hanok alley, Seongsu-dong cafes, Yeonnam-dong, Mangwon neighborhood',
  like_local:
    'local cafes, neighborhood walks, pojangmacha experiences, jjimjilbang',
  ...
  nature_sub:
    'national parks, scenic viewpoints, botanical gardens, riverside walks',
};
